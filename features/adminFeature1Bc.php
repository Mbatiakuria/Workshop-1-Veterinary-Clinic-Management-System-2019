<?php
	...
	if(!isAdmin()) {
		...
		if(isset($_GET['error'])&&$_GET['error']=='doctor-cannot-be-deleted') {
			echo '<script>alert("Sorry, this user type cannot be deleted. Please try again.");window.location.href="'.htmlspecialchars($_SERVER['PHP_SELF']).'";</script>';
		}
	}
?>
<!DOCTYPE hmtl>
	...
	<body>
		...
		<div class="my-background">
			...
			<div class="login-form">
				<h2 class="login-form-header">Delete User</h2>
				<h3 class="login-form-header">Search user by id: </h3>
				<form action="../scripts/search-user-for-delete.php" method="post">
